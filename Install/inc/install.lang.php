...
$lang = array(
	...
	'install_title' => 'XYHCMS 1.0 正式版 安装向导',
	'welcome_to_install' => '欢迎安装',
	'install_wizard' => '安装向导',
	'install_error' => '安装出错',
	'install_tips' => '注意事项',
	'install_tips_content' => '这个安装程序仅仅用在你首次安装XYHCMS。如果你已经在使用 XYHCMS 或者要更新到一个新版本，请不要运行这个安装程序。',
	'install_notes' => '安装须知',
	'install_notes_content' => '<p>一、运行环境需求：PHP(5.2.0+)+MYSQL(4.1+)</p><p>二、安装步骤：<br />1、使用ftp工具以二进制模式，将该软件包里的 XYHCMS 目录下的文件上传到您的空间，假设上传后目录网站根目录。<br />2、如果您使用的是Linux 或 Freebsd 服务器，先确认以下目录或文件属性为 (777) 可写模式。<br />目录: install<br />文件: config.php<br />3、运行 http://www.yufu5.com/install/index.php 安装程序，填入安装相关信息与资料，完成安装！<br />4、运行 http://www.yufu5.com/index.php 开始体验XYHCMS2.0Beta版！<br />5、如安装完成后访问异常，请手动删除admin/Runtime和Apps/Runtime目录下所有文件。</p>',
	'install_env' => '运行环境检测',
	'php_os' => '操作系统',
	'php_version' => 'PHP版本',
	'file_upload' => '附件上传',
