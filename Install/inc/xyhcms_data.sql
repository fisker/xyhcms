...
INSERT INTO `#xyh#_attachment` (`id`, `title`, `filepath`, `filetype`, `filesize`, `haslitpic`, `uploadtime`, `aid`, `userid`) VALUES(1, '1.jpg', '/uploads/img1/201403/533919a874460.jpg', 1, 46067, 1, 1396251048, 1, 0);
INSERT INTO `#xyh#_attachment` (`id`, `title`, `filepath`, `filetype`, `filesize`, `haslitpic`, `uploadtime`, `aid`, `userid`) VALUES(2, '2.jpg', '/uploads/img1/201403/53391ad0dbbbc.jpg', 1, 69350, 1, 1396251345, 1, 0);
INSERT INTO `#xyh#_attachment` (`id`, `title`, `filepath`, `filetype`, `filesize`, `haslitpic`, `uploadtime`, `aid`, `userid`) VALUES(3, '3.jpg', '/uploads/img1/201403/53391bf80a62e.jpg', 1, 89740, 1, 1396251640, 1, 0);
INSERT INTO `#xyh#_attachment` (`id`, `title`, `filepath`, `filetype`, `filesize`, `haslitpic`, `uploadtime`, `aid`, `userid`) VALUES(4, '1.jpg', '/uploads/img1/201403/53391deab6d3b.jpg', 1, 39309, 1, 1396252139, 1, 0);
INSERT INTO `#xyh#_attachment` (`id`, `title`, `filepath`, `filetype`, `filesize`, `haslitpic`, `uploadtime`, `aid`, `userid`) VALUES(5, '2.jpg', '/uploads/img1/201403/53391dee1e3e8.jpg', 1, 28378, 1, 1396252142, 1, 0);
INSERT INTO `#xyh#_attachment` (`id`, `title`, `filepath`, `filetype`, `filesize`, `haslitpic`, `uploadtime`, `aid`, `userid`) VALUES(6, '3.jpg', '/uploads/img1/201403/53391df14c069.jpg', 1, 43833, 1, 1396252145, 1, 0);
...
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(1, 1, 3, '');
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(2, 2, 3, '');
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(3, 3, 3, '');
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(4, 1, 4, '');
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(5, 1, 4, '');
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(6, 1, 4, '');
INSERT INTO `#xyh#_attachmentindex` (`attid`, `arcid`, `modelid`, `desc`) VALUES(6, 1, 0, 'special');
...
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(1, '公司介绍', 'about', 0, 2, 0, '', '公司介绍', '网络科技有限公司成立于2007年。是一家集科研、生产、开发、销售为一体的互联网产业高新技术企业。 我公司在全国与多个大型门户网站保持密切技术合作与往来；并且与全国多所高校合作，开发与研究互联网深度产品，取得了不错的研究成果，获得良好的好评', '', 'List_page.html', 'Show_page.html', '<p>　　网络科技有限公司成立于2007年。是一家集科研、生产、开发、销售为一体的互联网产业高新技术企业。 我公司在全国与多个大型门户网站保持密切技术合作与往来；并且与全国多所高校合作，开发与研究互联网深度产品，取得了不错的研究成果，获得良好的好评。公司具备优秀的技术梯队，多年来一直致力于以互联网为依托，开发各类型公司企业网站、行业网站、个人网站。以及销售涵盖国内大部分公司企业需要的成熟的管理配套软件、OA系统、定制系统等。还开展有域名注册、服务器托管租用等互联网基础数据业务。上谷网络品牌也是湖北互联网行业里的信得过品牌，为国内几万家企业提供互联网服务与咨询!</p>', 1, 1);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(2, '新闻中心', 'xinwenzhongxin', 0, 1, 0, '新闻中心', '', '', '', 'List_article.html', 'Show_article.html', NULL, 1, 2);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(3, '公司新闻', 'gongsixinwen', 2, 1, 0, '公司新闻', '', '', '', 'List_article.html', 'Show_article.html', NULL, 1, 1);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(4, '行业新闻', 'xingyexinwen', 2, 1, 0, '行业新闻', '', '', '', 'List_article.html', 'Show_article.html', NULL, 1, 1);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(5, '产品展示', 'chanpinzhanshi', 0, 3, 0, '产品展示', '', '', '', 'List_product.html', 'Show_product.html', NULL, 1, 3);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(6, '家具类', 'jiaju', 5, 3, 0, '家具产品', '', '', '', 'List_product.html', 'Show_product.html', NULL, 1, 1);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(7, '工艺品系列', 'gongyipinxilie', 5, 3, 0, '工艺品系列', '', '', '', 'List_product.html', 'Show_product.html', NULL, 1, 1);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(8, '公司相册', 'gongsixiangce', 0, 4, 0, '公司相册', '', '', '', 'List_picture.html', 'Show_picture.html', NULL, 1, 5);
INSERT INTO `#xyh#_category` (`id`, `name`, `ename`, `pid`, `modelid`, `type`, `seotitle`, `keywords`, `description`, `template_category`, `template_list`, `template_show`, `content`, `status`, `sort`) VALUES(9, '在线留言', '@guestbook/index', 0, 0, 1, '', '', '', '', 'List_article.html', 'Show_article.html', NULL, 1, 6);
...
INSERT INTO `#xyh#_picture` (`id`, `title`, `color`, `keywords`, `litpic`, `description`, `copyfrom`, `template`, `pictureurls`, `content`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(1, '迷幻炫彩', '', '', '/uploads/img1/201403/53391df14c069.jpg!200X200.jpg', '', '', '', '/uploads/img1/201403/53391df14c069.jpg$$$$$$|||/uploads/img1/201403/53391deab6d3b.jpg$$$$$$|||/uploads/img1/201403/53391dee1e3e8.jpg$$$$$$', '<p>迷幻炫彩，很好看的图片</p>', 1396252161, 1396252161, 398, 8, 1, 0, '', 0, 0, 1);
...
INSERT INTO `#xyh#_product` (`id`, `title`, `color`, `keywords`, `litpic`, `pictureurls`, `content`, `description`, `price`, `trueprice`, `brand`, `units`, `specification`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(1, '皇室五件套', '', '', '/uploads/img1/201403/533919a874460.jpg!200X200.jpg', '/uploads/img1/201403/533919a874460.jpg$$$$$$', '<p>千年黄花梨</p><p>珍贵材种中国海南吊罗山黄花梨木高档实木皇室五件套尊贵经典，雕刻精密，结构稳定，其木纹如行云流水、质地坚韧缜密如玉，木色瑰丽动人.</p>', '', 0, 0, '云峰', '个', '标准', 1396251156, 1396251156, 10, 6, 1, 0, '', 0, 0, 1);
INSERT INTO `#xyh#_product` (`id`, `title`, `color`, `keywords`, `litpic`, `pictureurls`, `content`, `description`, `price`, `trueprice`, `brand`, `units`, `specification`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(2, '圆桌5件套', '', '', '/uploads/img1/201403/53391ad0dbbbc.jpg!200X200.jpg', '/uploads/img1/201403/53391ad0dbbbc.jpg$$$$$$', '<p>圆桌5件套</p><p>产地为缅甸，材质为鸡翅木</p>', '', 0, 0, '云峰', '个', '标准', 1396251333, 1396251333, 36, 6, 1, 0, '', 0, 0, 1);
INSERT INTO `#xyh#_product` (`id`, `title`, `color`, `keywords`, `litpic`, `pictureurls`, `content`, `description`, `price`, `trueprice`, `brand`, `units`, `specification`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(3, '吉象如意', '', '', '/uploads/img1/201403/53391bf80a62e.jpg!200X200.jpg', '/uploads/img1/201403/53391bf80a62e.jpg$$$$$$', '<p>阔叶黄檀，蝶形花科Fabaceae，另一拉丁学名Dalbergia emarginata Roxb是一种具备关紧经济价值的树种，在国际市场上一般叫做它为印度一种植物的花木&quot;Indian Rosewood&quot;，它主要用于制造高级家具和工艺品和扮饰材料以及医疗药品用场等。<br/>汉字学名：阔叶黄檀 <br/>拉丁学名：Fabaceae <br/>界：植物界 <br/>科：豆科 <br/>亚科：蝶形花亚科 <br/>种：黑酸枝类 <br/>散布地区范围：喜马拉雅山系以南的尼泊尔、巴基斯坦到孟加拉湾两岸。</p>', '', 0, 0, '云峰', '个', '标准', 1396251643, 1396251643, 79, 7, 1, 0, '', 0, 0, 1);
...
INSERT INTO `#xyh#_special` (`id`, `title`, `shorttitle`, `color`, `author`, `keywords`, `litpic`, `description`, `content`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `filename`, `template`, `aid`) VALUES(1, '文章汇集', '', '', '', '', '/uploads/img1/201403/53391df14c069.jpg!200X200.jpg', '文章汇集', NULL, 1398668509, 1398668509, 82, 0, 1, 1, '', 0, '', 'Special_content.html', 1);
